        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-grid">
                    ...
                    <div className="footer-section">
                        <div className="footer-brand">
                            ...
                            <span className="footer-brand-text">ISL Translator</span>
                        </div>
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-links">
                            ...
                            <li><Link to="/sign-to-speech">ISL to Speech</Link></li>
                            <li><Link to="/speech-to-sign">Speech to ISL</Link></li>
                ...
                <div className="footer-bottom">
                    <p>&copy; {new Date().getFullYear()} ISL Translator. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
